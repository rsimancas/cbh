Ext.define('CBH.model.sales.qsumFileQuoteChargesByGLAccount', {
	extend: 'Ext.data.Model',

	fields: [
    	{ name:'FileKey', type:'int', defaultValue: null },
        { name:'QHdrKey', type:'int', defaultValue: null },
        { name:'QCDGLAccount', type:'int', useNull: true, defaultValue: null },
        { name:'FreightCo', type:'string', useNull: true, defaultValue: null },
        { name:'Cost', type:'float', useNull: true, defaultValue: null },
        { name:'Price', type:'float', useNull: true, defaultValue: null },
        { name:'Estimated', type:'int', useNull: true, defaultValue: null },
