...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class tlkpGenericListsController : ApiController
    {
        ...
        public object GetAll()
        {
           var queryValues = Request.RequestUri.ParseQueryString();
            ...
            try
            {
                ...
                {
                    object json;
                    IList<tlkpGenericLists> lista;

                    lista = repository.GettlkpGenericLists(query, sort, filter, page, start, limit, ref totalRecords);
                ...
                {
                    tlkpGenericLists genericList = repository.GettlkpGenericLists(id);
        ...
        public object Post(tlkpGenericLists model)
        {
            object json;
            string messageError = "";
        ...
        public object Put(tlkpGenericLists model)
        {
            object json;
        ...
        public object Delete(tlkpGenericLists model)
        {
