...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class ChargeCategoriesController : ApiController
    {
        ...
        public object GetAll()
        {
           var queryValues = Request.RequestUri.ParseQueryString();
            ...
            try
            {
                ...
                {
                    object json;
                    IList<ChargeCategories> lista;

                    lista = repository.GetListChargeCategories(query, sort, filter, page, start, limit, ref totalRecords);
                ...
                {
                    ChargeCategories qcharge = repository.GetChargeCategory(id);
        ...
        public object Post(ChargeCategories model)
        {
            object json;
            string messageError = "";
        ...
        public object Put(ChargeCategories model)
        {
            object json;
        ...
        public object Delete(ChargeCategories model)
        {
