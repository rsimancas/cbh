...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class qsumFileQuoteVendorSummaryController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            {
                object json;
                IList<qsumFileQuoteVendorSummary> lista;

                lista = repository.GetqsumFileQuoteVendorSummary(QHdrKey);
