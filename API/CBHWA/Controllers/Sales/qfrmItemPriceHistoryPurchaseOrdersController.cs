...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class qfrmItemPriceHistoryPurchaseOrdersController : ApiController
    {
        ...
        public object GetAll()
        {
           var queryValues = Request.RequestUri.ParseQueryString();
            ...
            {
                    object json;
                    IList<qfrmItemPriceHistoryPurchaseOrder> lista;

                    lista = repository.GetqfrmItemPriceHistoryPurchaseOrders(ItemKey, query, sort, filter, page, start, limit, ref totalRecords);
