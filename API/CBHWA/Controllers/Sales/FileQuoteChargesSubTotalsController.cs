...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class FileQuoteChargesSubTotalsController : ApiController
    {
        ...
        public object GetAll()
        {
           var queryValues = Request.RequestUri.ParseQueryString();
            ...
            int subTotalKey = Convert.ToInt32(queryValues["subtotalkey"]);
            ...
            try
            {
                ...
                {
                    object json;
                    IList<FileQuoteChargesSubTotals> lista;

                    lista = repository.GetListQuoteChargesSubTotals(query, sort, filter, page, start, limit, ref totalRecords);
                ...
                {
                    FileQuoteChargesSubTotals qchargeST = repository.GetQuoteChargesSubTotals(subTotalKey, qhdrKey);
        ...
        public object Post(FileQuoteChargesSubTotals model)
        {
            object json;
            string messageError = "";
        ...
        public object Put(FileQuoteChargesSubTotals model)
        {
            object json;
        ...
        public object Delete(FileQuoteChargesSubTotals model)
        {
