...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class qryFileSearchController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            {
                object json;
                IList<qryFileSearch> lista;

                lista = repository.GetqryFileSearch(query, sort, filter, page, start, limit, ref totalRecords);
