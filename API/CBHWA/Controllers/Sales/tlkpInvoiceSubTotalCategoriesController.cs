...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class tlkpInvoiceSubTotalCategoriesController : ApiController
    {
        ...
        public object GetAll()
        {
           var queryValues = Request.RequestUri.ParseQueryString();
            ...
            try
            {
                ...
                {
                    object json;
                    IList<tlkpInvoiceSubTotalCategories> lista;

                    lista = repository.GettlkpInvoiceSubTotalCategories(query, sort, filter, page, start, limit, ref totalRecords);
                ...
                {
                    tlkpInvoiceSubTotalCategories stDesc = repository.GettlkpInvoiceSubTotalCategories(id);
        ...
        public object Post(tlkpInvoiceSubTotalCategories model)
        {
            object json;
            string messageError = "";
        ...
        public object Put(tlkpInvoiceSubTotalCategories model)
        {
            object json;
        ...
        public object Delete(tlkpInvoiceSubTotalCategories model)
        {
