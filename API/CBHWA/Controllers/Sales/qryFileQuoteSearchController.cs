...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class qryFileQuoteSearchController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            {
                object json;
                IList<qryFileQuoteSearch> lista;

                lista = repository.GetqryFileQuoteSearch(query, sort, filter, page, start, limit, ref totalRecords);
