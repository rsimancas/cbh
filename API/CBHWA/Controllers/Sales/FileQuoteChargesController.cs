...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class FileQuoteChargesController : ApiController
    {
        ...
        public object GetAll()
        {
           var queryValues = Request.RequestUri.ParseQueryString();
            ...
            try
            {
                ...
                {
                    object json;
                    IList<FileQuoteCharge> lista;

                    lista = repository.GetListQuoteCharges(query, sort, filter, page, start, limit, ref totalRecords);
                ...
                {
                    FileQuoteCharge qcharge = repository.GetQuoteCharges(id);
        ...
        public object Post(FileQuoteCharge model)
        {
            object json;
            string messageError = "";
        ...
        public object Put(FileQuoteCharge model)
        {
            object json;
        ...
        public object Delete(FileQuoteCharge model)
        {
