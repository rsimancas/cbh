    ...
    public class InvoiceHeaderController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            try
            {
                ...
                {
                    object json;
                    IList<InvoiceHeader> lista;

                    lista = repository.GetListInvoiceHeader(0, query, sort, page, start, limit, ref totalRecords);
                ...
                {
                    InvoiceHeader invoice = repository.GetInvoiceHeader(id);
        ...
        public object Put(InvoiceHeader model)
        {
            try
            {
