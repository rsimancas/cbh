...
namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class qryJobInvoiceSearchController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            {
                object json;
                var lista = repository.GetqryJobInvoiceSearch(query, sort, filter, page, start, limit, ref totalRecords);
