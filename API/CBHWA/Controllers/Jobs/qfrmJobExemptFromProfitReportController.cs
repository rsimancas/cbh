namespace CBHWA.Controllers
{
    ...
    [TokenValidation]
    public class qfrmJobExemptFromProfitReportController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            try
            {
                ...
                if (id == 0)
                {
                    ...
                    var lista = repository.GetJobExemptFromProfitReport(fieldFilters, query, sort, queryBy, page, start, limit, ref totalRecords);
        ...
        public object Post(qfrmJobExemptFromProfitReport model)
        {
            object json;
            string msgError = "";
        ...
        public object Put(qfrmJobExemptFromProfitReport model)
        {
            object json;
        ...
        public object Delete(qfrmJobExemptFromProfitReport model)
        {
            string msgError = "";
