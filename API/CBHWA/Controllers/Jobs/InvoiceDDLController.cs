...
{
    [TokenValidation]
    public class InvoiceDDLController : ApiController
    {
        ...
        public object GetAll()
        {
            ...
            {
                    object json;
                    IList<InvoiceDDL> lista;

                    lista = repository.GetListInvoiceDDL(jobkey, query, sort, page, start, limit, ref totalRecords);
